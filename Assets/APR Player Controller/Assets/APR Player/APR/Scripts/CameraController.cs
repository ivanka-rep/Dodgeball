...
public class CameraController : MonoBehaviour
{
    ...
    void Update()
    {
        currentX = currentX + Input.GetAxis("Horizontal") * rotateSpeed;
        currentY = currentY + Input.GetAxis("Vertical") * rotateSpeed;
    ...
    void FixedUpdate()
    {
        ...
        if(!rotateCamera)
        {
            var camPos = cam.transform.position; camPos.x = APRRoot.position.x;
            var targetRotation = Quaternion.LookRotation(APRRoot.position - camPos);
